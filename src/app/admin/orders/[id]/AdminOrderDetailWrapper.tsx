...
export default function AdminOrderDetailWrapper({ orderId }: { orderId: number }) {
  ...
  return (
    <section className="p-4 sm:px-0 grid grid-cols-1 sm:grid-cols-3 sm:auto-rows-auto gap-4 ">
      ...
      <div className="sm:col-start-3 sm:row-start-1 sm:row-end-3">
        <OrderHistory history={order.history} />
      </div>

      <div className="sm:col-start-1 sm:col-end-3 sm:row-start-2">
