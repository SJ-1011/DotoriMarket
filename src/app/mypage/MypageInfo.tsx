      ...
      {isLoading ? (
        ...
        <div className="flex flex-col flex-nowrap gap-12 w-[98%] sm:w-[600px] lg:flex-1 bg-white rounded-2xl shadow-[0_0_10px_rgba(0,0,0,0.1)] p-12">
          ...
          <ul className="flex flex-row flex-nowrap justify-between w-full px-12">
            ...
            <li className="flex flex-col flex-nowrap justify-center gap-2 items-center w-[6rem] lg:w-[8rem]">
              <Link href="/mypage/admin/orders" className="flex flex-col flex-nowrap text-xs lg:text-sm sm:w-[6rem] lg:w-[8rem] shadow-[0_0_5px_rgba(0,0,0,0.1)] aspect-square  p-2 sm:p-4 bg-white rounded-2xl sm:rounded-4xl justify-center items-center sm:gap-1 lg:gap-4">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-10">
                  <path
                    strokeLinecap="round"
            ...
            <li className="flex flex-col flex-nowrap justify-center gap-2 items-center w-[6rem] lg:w-[8rem]">
              <Link href="/mypage/admin/users" className="flex flex-col flex-nowrap text-xs lg:text-sm sm:w-[6rem] lg:w-[8rem] shadow-[0_0_5px_rgba(0,0,0,0.1)] aspect-square  p-2 sm:p-4 bg-white rounded-2xl sm:rounded-4xl justify-center items-center sm:gap-1 lg:gap-4">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-10">
            ...
            <li className="flex flex-col flex-nowrap justify-center gap-2 items-center w-[6rem] lg:w-[8rem]">
              <Link href="/mypage/admin/posts" className="flex flex-col flex-nowrap text-xs lg:text-sm sm:w-[6rem] lg:w-[8rem] shadow-[0_0_5px_rgba(0,0,0,0.1)] aspect-square  p-2 sm:p-4 bg-white rounded-2xl sm:rounded-4xl justify-center items-center sm:gap-1 lg:gap-4">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-10">
