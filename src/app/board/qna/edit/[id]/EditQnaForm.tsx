      ...
      <form action={formAction}>
        ...
        <div className="flex justify-end my-6 gap-2">
          ...
          <Link href={`/board/qna/${post._id}`}>
            <button type="button" className="px-4 py-2 rounded-xl w-20 sm:w-24 lg:w-28 bg-white text-[#A97452] text-xs sm:text-sm lg:text-base hover:bg-[#F5EEE6] transition-colors border-2 border-[#A97452]" disabled={isLoading}>
              취소
            </button>
          </Link>
        </div>
